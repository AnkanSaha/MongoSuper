# Contributing to MongoSuper

Welcome to MongoSuper! We appreciate your interest in contributing. By participating in this project, you agree to abide by the [Code of Conduct](CODE_OF_CONDUCT.md).
...
```bash
git clone https://github.com/AnkanSaha/MongoSuper.git
```
